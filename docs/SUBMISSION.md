...
## Built With
- **Python** — Executa plugin (mimir-memory) proxying Anna's JSON-RPC calls to Mimir
- **Mimir** (Rust) — Battle-tested persistent memory backend with SQLite + FTS5 full-text search
...
2. Install Mimir: https://github.com/tcconnally/mimir
